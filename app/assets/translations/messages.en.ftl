...
error-username-too-long = Username must be 15 characters or fewer.
...
upload-instructions-guest = For guest account uploads, the map name cannot be changed after uploading. They are not manually deletable and are automatically deleted after approximately two days.
upload-select-folder = Select Folder
upload-cancel = Cancel
upload-map-title = Map title
upload-map-name-locked =
    .title = Map name cannot be changed after uploading as a guest
upload-surfaces = Surfaces
upload-images = Images
upload-total-size = Total size
upload-start = Start Upload
upload-reselect-folder = Change Folder
upload-preparing = Preparing { $prepared } / { $total } files...
...
upload-error-expired = This map has expired and can no longer be uploaded to.
