...
RSpec.describe PastaAtlas::Actions::API::Uploads::PresignedUrls::Create, :db do
  ...
  let(:action) { PastaAtlas::Actions::API::Uploads::PresignedUrls::Create.new(issue_presigned_urls:, user_repo:) }
