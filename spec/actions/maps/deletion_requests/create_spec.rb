...
RSpec.describe PastaAtlas::Actions::Maps::DeletionRequests::Create, :action_env do
  let(:request_deletion) { instance_double(PastaAtlas::Operations::Maps::RequestDeletion) }
  let(:action) { PastaAtlas::Actions::Maps::DeletionRequests::Create.new(request_deletion:) }
