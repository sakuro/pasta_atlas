...
RSpec.describe PastaAtlas::Views::Maps::Index do
  ...
  it "renders a link for each map" do
    html = render(maps: [alice_map, bob_map], users_by_id: {1 => alice, 2 => bob}, page: 1, per_page: 20, total: 2)
  ...
  it "renders the user name" do
    html = render(maps: [alice_map], users_by_id: {1 => alice}, page: 1, per_page: 20, total: 1)
  ...
  it "renders a next link when more pages remain" do
    html = render(maps: [alice_map], users_by_id: {1 => alice}, page: 1, per_page: 1, total: 2)
  ...
  it "renders a previous link on pages after the first" do
    html = render(maps: [bob_map], users_by_id: {2 => bob}, page: 2, per_page: 1, total: 2)
